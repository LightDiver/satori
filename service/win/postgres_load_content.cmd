...
echo %path_to_file%
@call "%pg_install%"\psql.exe -h %pg_host% -d %Postgres_DB% -U %pg_User_name% -v path_to_file='%path_to_file% -f 001.01\11-load\load_files.sql -L %OutTemps%\11-load_files.log -o %OutTemps%\11-load_files.log
