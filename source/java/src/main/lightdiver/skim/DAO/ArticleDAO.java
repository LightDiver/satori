...
public class ArticleDAO {
    ...
    public static int getPublicArticleList(String userSession, String userKey, String ipAddress, Integer CategoryID, String LangID, List<Article> outListArticle) throws BaseNotConnect {
        Connection con = ConnectionPool.takeConn();
        CallableStatement cs = null;
        outListArticle.clear();
        int res = -1;
